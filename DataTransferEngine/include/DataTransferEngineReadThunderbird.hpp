/**
 * @file DataTransferEngineReadThunderbird.hpp
...
class DataTransferEngineReadThunderbird final : public DataTransferEngineReadBase {
public:
    explicit DataTransferEngineReadThunderbird(std::string devNode);

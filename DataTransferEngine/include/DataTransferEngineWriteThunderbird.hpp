/**
 * @file DataTransferEngineWriteThunderbird.hpp
...
class DataTransferEngineWriteThunderbird final : public DataTransferEngineWriteBase {
public:
    explicit DataTransferEngineWriteThunderbird(std::string devNode);

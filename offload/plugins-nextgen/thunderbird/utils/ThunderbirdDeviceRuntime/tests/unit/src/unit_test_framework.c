...
int run_all_unit_tests(void) {
    ...
    printk("=================================================================\n");
    printk("Framework Version: 2.0 (using common framework)\n");
    printk("Date: August 11, 2025\n");
    printk("Author: Michael Brothers (mBrothers@inspiresemi.com)\n");
    printk("=================================================================\n");

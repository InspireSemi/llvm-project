...
// Implementation of getMessageIdString
...
// Implementation of getErrorCodeString
...
// Implementation of printMallocCmd
...
// Implementation of printMallocRsp
...
// Implementation of printFreeCmd
void printFreeCmd(const free_cmd_t* payload) {
    std::cout << "  Address: 0x" << std::hex << payload->address << std::dec << "\n";
    std::cout << "  Reserved: 0x" << std::hex << payload->reserved << std::dec << "\n";
}

// Implementation of printFreeRsp
void printFreeRsp(const free_rsp_t* payload) {
    std::cout << "  Status: " << getErrorCodeString(payload->status) << " (" << payload->status << ")\n";
    std::cout << "  Reserved: 0x" << std::hex << payload->reserved << std::dec << "\n";
}

// Implementation of printLaunchCmd
...
// Implementation of printBatchBeginCmd
...
// Implementation of printBatchEndCmd
...
// Implementation of printBatchBeginRsp
...
// Implementation of printBatchEndRsp
...
// Implementation of printInternalInvalidateSlots
...
// Implementation of printMemoryStatusRsp
...
// Implementation of printRawData
...
// Implementation of classifyMessage
...
// Implementation of printMessagePayload
...
// Implementation of printMessageSlot
...
// Implementation of initMessageSlot
...
// Implementation of createMallocCmd
bool createMallocCmd(message_slot_t* slot, uint32_t size, uint32_t alignment) {
...
// Implementation of createFreeCmd
...
// Implementation of createLaunchCmd
...
// Implementation of createQueryDeviceCmd
bool createQueryDeviceCmd(message_slot_t* slot, uint32_t query_flags) {
...
// Implementation of createBatchBeginCmd
...
// Implementation of createBatchEndCmd
...
// Implementation of createBatchBeginRsp
...
// Implementation of createBatchEndRsp
...
// Implementation of createPing
bool createPing(message_slot_t* slot, uint32_t timestamp) {
    if (!slot) return false;
